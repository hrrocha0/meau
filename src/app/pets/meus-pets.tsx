...
export default function MeusPetsScreen() {
  ...
  const handleToggleHidden = useCallback(async (pet: Pet) => {
    ...
    setPets((currentPets) =>
      currentPets.map((currentPet) => (currentPet.id === pet.id ? { ...currentPet, oculto: nextOculto } : currentPet)),
    );
    ...
    try {
      ...
      setPets((currentPets) =>
        currentPets.map((currentPet) =>
          currentPet.id === pet.id ? { ...currentPet, oculto: pet.oculto ?? false } : currentPet,
        ),
      );
    }
  }, []);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.screen}>
        ...
        <Modal visible={!!editingPet} transparent animationType="fade" onRequestClose={handleCloseEditPet}>
          <Pressable style={styles.modalBackdrop} onPress={handleCloseEditPet}>
            <Pressable style={styles.modalCard}>
              ...
              <View style={styles.modalActions}>
                ...
                >
                  <Text style={styles.primaryButtonText}>{isSavingPet ? "SALVANDO..." : "SALVAR"}</Text>
                </Pressable>
              </View>
            </Pressable>
          </Pressable>
