...
export function InputField({
  ...
  return (
    <View style={styles.wrapper}>
      <Pressable style={styles.inputRow} onPress={onPress} disabled={!onPress}>
        <TextInput
          style={styles.input}
        ...
        {showDropdownIndicator ? <Ionicons name="chevron-down" size={18} color={colors.onSurfaceContainer} /> : null}
      </Pressable>
